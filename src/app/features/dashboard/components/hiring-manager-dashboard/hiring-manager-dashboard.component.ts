...
/**
 * This tells the frontend which section
 * triggered the API request.
 */
...
export class HiringManagerDashboardComponent
  ...
  async ngOnInit(): Promise<void> {
     ...
     *
     * Since there is no specific filter yet,
  ...
  async loadDashboardAnalytics(
    ...
    try {
      ...
      if (
         ...
         * here.
         *
         * Because that updates every section.
         *
         * Instead update only the section that triggered
         * this API call.
         */
  ...
  private mapAnalyticsResponse(
     ...
     * ========================================================
     *
     * Update ONLY Offer Status.
     *
     * Pipeline remains unchanged.
     *
     * Negotiation remains unchanged.
     */
     ...
     * ========================================================
     *
     * Update ONLY Negotiation.
     *
     * Pipeline remains unchanged.
     *
     * Offer Status remains unchanged.
     */
  ...
  handleData(
     ...
     * New SR selected.
     *
     * Load ALL sections because this is
     * a completely new dashboard context.
     */
